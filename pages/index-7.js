                    ...
                    <div className="col-lg-6">
                      <div className="box-cover-pd-2">
                        <h2 className="color-brand-1 mb-30">
                          How to grow your <br className="d-none d-lg-block" />
                          business fast
                        </h2>
            ...
            <div className="row align-items-center">
              <div className="col-lg-5 mb-30">
                ...
                <p className="font-md color-grey-400">
                  ...
                  holdings, values and equity over time. Monitor markets, manage
                  your portfolio, and trade crypto on the go.
                </p>
                <div className="mt-40">
              ...
              <div className="col-lg-7 text-center position-relative mb-30">
                <img src="/assets/imgs/page/homepage7/img-2.png" alt="iori" />
                <div className="shape-1 box-image-4">
                  <img src="/assets/imgs/page/homepage7/chart.png" alt="iori" />
                </div>
