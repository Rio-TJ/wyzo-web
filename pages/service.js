                ...
                <div className="col-lg-7">
                  <div className="box-business-service">
                    ...
                    <div className="box-image-1 shape-3">
                      {" "}
                      <img src="assets/imgs/page/service/img1.png" alt="iori" />
                    </div>
                    <div className="box-image-2 shape-2">
                      {" "}
                      <img src="assets/imgs/page/service/img2.png" alt="iori" />
                    </div>
                    <div className="box-image-3 shape-1">
                      {" "}
                      <img src="assets/imgs/page/service/img4.png" alt="iori" />
                      <div className="cardNumber bg-white">
          ...
          <div className="container">
            <div className="row align-items-end">
              <div className="col-lg-8 col-md-8">
                <h2 className="color-brand-1 mb-20">From our blogasd </h2>
                <p className="font-lg color-gray-500">
